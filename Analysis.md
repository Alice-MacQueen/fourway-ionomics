...
## Elemental abundance correlations
...
Correlations were typically larger at KBSM than at PKLE or CLMB.
...
More Mg26 non-overlapping QTL than expected (6, 2.3 expected). I bet some of these could be related to Mg's essential function in chlorophyll molecules.
Fewer Ca44 non-overlapping QTL than expected (0, 1.3 expected), and fewer Al27 non-overlapping QTL than expected (0, 1 expected). I bet Ca might overlap a lot with other 2A elements, or 2+ elements, like Mg, Sr, Zn, even Fe. Not sure about Al...
